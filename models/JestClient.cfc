	...
	singleton
{
	...
	**/
	 ...
	 * Util provider
	 */
	cbElasticsearch.models.Util function getUtil() provider="Util@cbElasticsearch"{}
	...
	**/
	...
	struct function getIndices( verbose = false ){
		// we can access all of our indices from the stats
  ...
  *
	...
	**/
	...
	private any function buildDeleteAction( required cbElasticsearch.models.Document document ){
	...
	private any function buildUpdateAction( required cbElasticsearch.models.Document document ){
